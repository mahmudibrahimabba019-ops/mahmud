...
try:
    ...
    cust = {
        'email': 'test+automation2@example.com',
        'phone': '08000000003',
        'first_name': 'Auto',
        'last_name': 'Tester',
    ...
    write('Customer create response: ' + json.dumps(data))
    ...
    write('Fetched order: ' + json.dumps(data3))
    write('Persisted payment_reference: ' + str(data3.get('payment_reference')))
    ...
    try:
        ...
        body = ''
    write('HTTPError: ' + str(e.code) + ' ' + str(e.reason) + ' ' + body)
